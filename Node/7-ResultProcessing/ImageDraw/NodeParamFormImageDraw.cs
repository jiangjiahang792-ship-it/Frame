...
namespace TDJS_Vision.Node._7_ResultProcessing.ImageDraw
{
    public partial class NodeParamFormImageDraw : FormBase, INodeParamForm
    {
        ...
        /// </summary>
        /// <returns></returns>
        public AlgorithmResult GetColorResults()
        {
            AlgorithmResult res = null;
            try
            {
                res = nodeSubscription3.GetValue<AlgorithmResult>();
            }
            catch (Exception)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                param.Text5 = nodeSubscription3.GetText1();
                param.Text6 = nodeSubscription3.GetText2();
