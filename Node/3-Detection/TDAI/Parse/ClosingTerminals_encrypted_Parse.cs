...
namespace TDJS_Vision.Node._3_Detection.TDAI.Parse
{
    ...
    /// 瑞领12类端子模型
    /// </summary>
    public class ClosingTerminals_encrypted_Parse
    {
        /// <summary>
