...
namespace TDJS_Vision.Node._6_LogicTool.CompositeModule
{
    ...
    /// 组合输入节点运行结果。
    /// </summary>
    public class NodeResultCompositeInput : INodeResult, IDynamicResultVariables, IDynamicResultVariableTypeProvider
    {
        /// <summary>
        /// 节点运行耗时。
        /// </summary>
        ...
        public static NodeResultCompositeInput BuildFailure(string message)
        {
