    ...
    public partial class FrmLightNew : FormBase
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(this.textBoxLightName.Text))
            {
                ...
                try
                {
                    lightParam.Brand = this.comboBoxBrand.Text == "磐鑫" ? DeviceBrand.PPX : this.comboBoxBrand.Text == "锐视" ? DeviceBrand.Rsee: this.comboBoxBrand.Text == "瞳达" ? DeviceBrand.TDJS : DeviceBrand.Unknow;
        ...
        private void comboBoxBrand_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if(comboBoxBrand.SelectedIndex == 1)
            {
