...
namespace TDJS_Vision.Device.Light
{
    ...
    public class LightTDJS : ILight
    {
        ...
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public DeviceBrand Brand { get; set; } = DeviceBrand.TDJS;
        public string ClassName { get; set; } = typeof(LightTDJS).FullName;
        ...
        public LightTDJS(LightParam lightParam)
        {
            try
            {
                foreach (var serialPort in FrmLightListView.OccupiedComList)
